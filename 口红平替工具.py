...
def 画出购买(当前):
    ...
    with 淘宝:
        st.link_button("去淘宝找", 当前["购买链接"], use_container_width=True)
    with 京东:
        st.link_button("去京东找", 当前["京东链接"], use_container_width=True)
    with 拼多多:
        st.link_button("去拼多多找", 当前["拼多多链接"], use_container_width=True)
